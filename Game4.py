import Classes4                                             #Imports modules
import pygame
import random
import time
...
def main(puntuacion,nombre):
    ...
    object4find   = pygame.image.load("img/maya4.png").convert_alpha()
    object5find   = pygame.image.load("img/maya5.png").convert_alpha()
